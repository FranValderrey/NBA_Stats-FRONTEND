...
const SeasonPage = ({ season, seasonStats }) => {
  // Decodificar el valor de la temporada antes de mostrarlo en el título
  const decodedSeason = decodeURIComponent(season);

  return (
    <div>
      <h1>Estadísticas de la temporada {decodedSeason}</h1>
      {seasonStats ? (
        <div>
          <h2>Partidos</h2>
          <ul>
